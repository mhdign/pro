...
// Import Jalali date picker components
...
export default function SignupPage() {
    ...
    async function onSubmit(data) {
        ...
        try {
            ...
            if (res?.data?.ok) {
                ...
                setServerError(res.data?.message || "خطا در ثبت‌نام");
                setLoading(false);
            }
        } catch (err) {
            setServerError(
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-900 transition-all duration-500 py-8">
            <LoadingLogo visible={loading} text="در حال ثبت‌نام..." />
            ...
            >
                <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-slate-700/20 p-8">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        >
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="حداقل 8 کاراکتر با حروف بزرگ و کوچک"
                        ...
                        {/* Birthdate Field with Jalali Date Picker */}
                        <motion.div
                            initial={{ opacity: 0, x: -20 }}
                            animate={{ opacity: 1, x: 0 }}
                        ...
                        >
                            ...
                            <div className="relative">
                                <Calendar className="absolute right-3 top-1/2 transform -translate-y-1/2 text-slate-400 w-5 h-5 z-10" />
                                <Controller
                                    control={control}
                                    name="birthdate"
                                    render={({ field: { onChange, value } }) => (
                                        <DatePicker
                                            ...
                                            className={`w-full pl-12 pr-4 py-4 rounded-2xl border-2 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-indigo-500/20 dark:bg-slate-700 dark:border-slate-600 dark:text-slate-100 ${
                                                errors.birthdate 
                                                    ? "border-red-400 focus:border-red-500 focus:ring-red-500/20" 
                                                    : watchedValues.birthdate && !errors.birthdate
                                                    ? "border-green-400 focus:border-green-500 focus:ring-green-500/20"
                                                    : "border-slate-200 focus:border-indigo-500"
                                            }`}
                                            style={{
